...
with left_column:
    ...
    st.header(":red[Passionate for understanding users' needs and data!]")
...
with st.container():
    ...
    st.write(
        """
**:blue[Being an expert with a broad knowledge base and deep expertise in the IT field has always been my ultimate goal.]** I got a degree in software engineering while working full-time. It was certainly a challenge but it has allowed me to develop better time management skills. Having once lost my way, I never thought about giving up. My commitment to succeed has pushed me to go further. By consistently challenging the status quo and applying my updated knowledge, I became the first and only business developer in AsiaYo who was assigned to work alongside a team of engineers to handle anomaly detection of API integration. After being promoted to a key account manager in the midst of company downsizing due to the pandemic, I’ve broadened my skills in team training, user journey optimization, and business analytics. I also deliberately fought for the opportunities to build product requirements documents with the developers. This process made me realize that I felt the most rewarding when I could increase higher product usage and consequently reduce the churn rate by creating values for the software users. Therefore, I honed in and secured a position as a solution implementation consultant at a Singaporean HR information system company, helping clients find their latent needs and make the most of our solutions. My professional trajectory has shown that I am always moving towards my goal. 

My authentic happiness lies in surpassing yesterday's self. This driving force can be proved by the activities I attended, the GitHub projects I built, and Medium articles written in my leisure time. My intrinsic drive allows me to evolve and learn constantly without external force. Whenever I pulled through something, I would ask myself: “What can I learn from this experience?” and “How can I do better next time?” During the whole process, I acquired a better analytical mindset and skills, a daring heart to do something new, an attribute of seeking inputs from others, and unstoppable perseverance born from overcoming internal struggles under extreme pressure. With the hard skills and soft skills accumulated from the past, now, I can confidently say that I am a problem solver having an insatiable appetite for pushing myself to manage time better for new challenges and think out of the box. 
